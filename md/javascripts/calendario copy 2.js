(() => {
  ...
  const tasquesGantt = [
    ...
    { codi: "U03", nom: "PHP OO",                           inici: "2026-09-30", dies: 25, cls: "u03", bloc: "php" },
    { codi: "U04", nom: "Programación Web",                 inici: "2026-10-25", dies: 10, cls: "u04", bloc: "php" },
    { codi: "U05", nom: "Acceso a BD",                      inici: "2026-11-04", dies: 10, cls: "u05", bloc: "php" },

    /* Laravel */
    { codi: "U06", nom: "Entorno de Desarrollo Profesional", inici: "2026-10-25", dies: 8,  cls: "u06", bloc: "laravel" },
    { codi: "U07", nom: "Fundamentos",                       inici: "2026-11-02", dies: 18, cls: "u07", bloc: "laravel" },
    { codi: "U08", nom: "Gestión de datos",                  inici: "2026-11-20", dies: 20, cls: "u08", bloc: "laravel" },
    { codi: "U09", nom: "Interacción con usuario",           inici: "2026-12-10", dies: 20, cls: "u09", bloc: "laravel" },
    { codi: "U10", nom: "Autenticación básica",              inici: "2026-12-30", dies: 12, cls: "u10", bloc: "laravel" },
    { codi: "U11", nom: "Despliegue",                        inici: "2027-01-11", dies: 7,  cls: "u11", bloc: "laravel" },

    /* Proyecto */
    { codi: "PROY", nom: "Pruebas finales",                  inici: "2026-12-10", dies: 40, cls: "proyecto", bloc: "proyecto" }
  ];
   ...
   * Solo se colorean lunes-viernes; los fines de semana mantienen
   * su estilo propio.
   */
  /*
   * IMPORTANTE:
  ...
  function afegeixPlanificacio(tasca) {
    ...
    for (let d = new Date(inici); d < fi; d.setDate(d.getDate() + 1)) {
      const capSetmana = d.getDay() === 0 || d.getDay() === 6;
      if (capSetmana) continue;
            ...
            <tbody>
              ${unitats.map(u => `
                <tr>
                  ...
                  <td class="hores ${u.cls}">${u.dies}</td>
