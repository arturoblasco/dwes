...
---
# <img src="../../img/php_azul.svg" width="40"> 4.2. Variable de servidor
...
???examplephp "Ejemplo"
    === "formulario02.html"
        ...
        ```
        <div style="text-align: center;"><figure><img src="../../img/ut04/server_form.png" alt="formulario para $_SERVER" style="zoom:75%;border: 2px solid #83abd4;" /></figure><figcaption class="figure-caption-small">🖼️ Figura 4.1: Formulario tipo GET</figcaption></figure></div>
    === "Resultado"
        ```php
        <?php
        // EJEMPLO:
        ...
        ```
        <div style="text-align: center;"><figure><img src="../../img/ut04/server_php.png" alt="php para $_SERVER" style="zoom:75%;border: 2px solid #83abd4;" /></figure><figcaption class="figure-caption-small">🖼️ Figura 4.2: Mostrar diferentes parámetros de $_SERVER</figcaption></figure></div>
