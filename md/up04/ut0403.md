...
---
# <img src="../../img/php_azul.svg" width="40"> 4.3. Formularios
...
=== "Formulario y retorno de $_FILES"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut04/files.png" alt="php para $_SERVER" style="zoom:85%;border: 2px solid #83abd4;" /></figure><figcaption class="figure-caption-small">🖼️ Figura 4.3: Parámetros de $_FILES</figcaption></figure></div>
