...
---
# <img src="../../img/php_azul.svg" width="40"> 4.5. Gestión de estado
...
> <div style="text-align: center;"><figure><img src="../../img/ut04/cookies.png" alt="img03_cookies1" style="zoom:90%;border: 2px solid #83abd4;" /></figure><figcaption class="figure-caption-small">🖼️ Figura 4.4: Tira cómica representando la obligatoriedad de aceptar las cookies en algunas páginas web</figcaption></figure></div>
...
???examplephp "Ejemplo de cookies"
	=== "1) `cookiesEj.html`"
        ...
        ```
		<div style="text-align: center;"><figure><img src="../../img/ut04/img03_cookies1.png" alt="img03_cookies1" style="zoom:50%;border: 2px solid #83abd4;" /></figure><figcaption class="figure-caption-small">🖼️ Figura 4.5: Ejemplo para mostrar en cookiesEj.html</figcaption></figure></div>
...
???examplephp "Ejemplo 2"
	...
	?>
	```
<div style="text-align: center;"><figure><img src="../../img/ut04/img01comunicacionCookies.png" alt="img01comunicacionCookies" style="zoom:50%;border: 2px solid #83abd4;" /></figure><figcaption class="figure-caption-small">🖼️ Figura 4.6: Resultado de una segunda petición a servidor con cookies</figcaption></figure></div>
...
<div style="text-align: center;"><figure><img src="../../img/ut04/img02comunicacionSesion.png" alt="img02comunicacionSesion" style="zoom:45%;border: 2px solid #83abd4;" /></figure><figcaption class="figure-caption-small">🖼️ Figura 4.7: Resultado de una segunda petición a servidor con sesiones</figcaption></figure></div>
...
???examplephp "Ejemplo"
    ...
    === "`ps2.php`"
        ...
        ```
    === "Resultado"
    	<div style="text-align: center;"><figure><img src="../../img/ut04/img04_session1.png" alt="img04_session1" style="zoom:50%;" /></figure><figcaption class="figure-caption-small">🖼️ Figura 4.8: Resultado para ejemplo</figcaption></figure></div>
