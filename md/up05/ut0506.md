...
title: 5.6. MySQLi
---
# <img src="../../img/php_azul.svg" width="40"> 5.6. MySQLi
...
!!!note "`servidor` en docker"
	...
	<div style="text-align: center;"><figure><img src="../../img/ut05/img06_06-mysql-servidor-docker.gif" style="zoom:80%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 5.4: l nombre del servidor, en Docker, será el ID o código del contenedor del servidor MySql</figcaption</figcaption></figure></div>
