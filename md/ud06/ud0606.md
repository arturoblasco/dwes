...
3. Refactorizar el código de la aplicación con la ayuda de la prueba para comprobar que no rompemos nada (refactor).
   ...
   <div style="text-align: center;"><img src="../../img/ud05/img03_tdd.png" style="max-width:50%;" /></div>
...
<div style="text-align: center;"><img src="../../img/ud05/img04_coverage.png" style="max-width: 85%;" /></div>
