...
title: 2.5. Funciones
---
# <img src="../../img/php_azul.svg" width="40"> 2.5. Funciones
...
=== "Ejemplo función"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova251.png" alt="prova 251" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.23: Ejemplo uso de funciones en php</figcaption></figure></div>
...
=== "Ejemplo argumentos por referencia"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova252.png" alt="prova 252" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.24: Ejemplo uso de parámetros por referencia en funciones</figcaption></figure></div>
...
=== "Ejemplo argumentos por defecto"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova253.png" alt="prova 253" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.25: Ejemplo de paso de parámetros en funciones por referencia</figcaption></figure></div>
...
=== "Ejemplo orden argumentos"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova254.png" alt="prova 254" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.26: Orden (después de otros tipos de parámetros) de los parámetros por defecto</figcaption></figure></div>
...
=== "Ejemplo argumentos variables"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova255.png" alt="prova 255" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.27: Ejemplo de uso de parámetros variables en funciones</figcaption></figure></div>
...
=== "Ejemplo *variadics*"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova256.png" alt="prova 256" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.28: Ejemplo uso del operador variadic (...) para convertir los parámetros en un array</figcaption></figure></div>
...
>     ```
> === "Resultado"
>     <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova257.png" alt="prova 257" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.29: Ejemplo inverso de uso de variadic</figcaption></figure></div>
...
=== "Ejemplo argumentos por nombre"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova258.png" alt="prova 258" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.30: Ejemplo uso de parámetros con nombre</figcaption></figure></div>
...
=== "Ejemplo orden argumentos"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova258.png" alt="prova 258" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.31: Orden de los parámetros con nombre (después de los que no tienen nombre)</figcaption></figure></div>
...
=== "Ejemplo función tipada"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova259.png" alt="prova 259" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.32: Ejemplo de función tipada</figcaption></figure></div>
...
=== "Ejemplo alcance local"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova25a.png" alt="prova 25a" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.33: Ejemplo de alcance local de las variables</figcaption></figure></div>
<br/>
=== "Ejemplo alcance global"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova25b.png" alt="prova 25b" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.34: Ejemplo de alcance global de las variables</figcaption></figure></div>
...
!!!note "Funciones anónimas"
    ...
    === "Ejemplo función anónima"
        ...
        ```
    === "Resultado"
        <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova25c.png" alt="prova 25c" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.35: Ejemplos de uso de función anónima en php</figcaption></figure></div>
...
=== "Php"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova25d.png" alt="prova 25d" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.36: Ejemplo de uso de biblibotecas en php</figcaption></figure></div>
...
=== "Página utilizando *include*"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova25e.png" alt="prova 25e" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.37: Ejemplo de uso de plantilla mediante include()</figcaption></figure></div>
