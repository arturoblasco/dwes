...
title: 2.4. Arrays
---
# <img src="../../img/php_azul.svg" width="40"> 2.4. Arrays
...
=== "Ejemplo recorrido *array*"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova241.png" alt="prova 241" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.18: Ejemplo  uso función count() en array para recorrer todos los elementos</figcaption></figure></div>
...
=== "Ejemplo recorrido *array* con *foreach*"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova241b.png" alt="prova 241b" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.19: Ejemplo de recorrido de todos los elementos de un array mediante la función foreach()</figcaption></figure></div>
...
=== "Ejemplo *array asociativo*"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova242.png" alt="prova 242" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.20: Ejemplos usos de array asociativos</figcaption></figure></div>
...
=== "Ejemplo *array bidimensional*"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova243.png" alt="prova 243" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.21: Ejemplo uso array de dos dimensiones</figcaption></figure></div>
...
=== "Ejemplo *array bidimensional* análogo a una tabla"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova244.png" alt="prova 244" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.22: Ejemplo similitud de arrays asocitivos con tablas</figcaption></figure></div>
