...
---
# <img src="../../img/php_azul.svg" width="40"> 2.3. Operadores
...
!!!examplephp "Diferencia entre `++$x` y `$x++`"
    === "Ejemplo `++$x`"
        ```php
        <?php
...
| Operador | Descripción | Ejemplo |
|----------|-------------|---------|
| **`and`** / **`&&`** | Verdadero si ambas condiciones son ciertas | cond1 && cond2 |
| **`or`** / `||` | Verdadero si al menos una condición es cierta | cond1 || cond2 |
| **`xor`** | Verdadero si solo una condición es cierta | cond1 xor cond2 |
| **`!`** | Negación | `!cond1` |
...
| `===` | Igualdad estricta (mismo orden y tipo) | $x === $` |
| `!=` / `<>` | Diferente | $x != $y |
| `!==` | No idéntico | $x !== $y |
...
!!!examplephp "Ejemplo operador ternario"
    === "Código"
        ...
        ```
    === "Resultado"
        <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova235.png" alt="prova 235" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.7: Ejemplo operador ternario y cadena formateada</figcaption></figure></div>
...
>     ```
> === "Resultado"
>     <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova236.png" alt="prova 235" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.8: Ejemplo orperador elvis</figcaption></figure></div>
...
=== "Resultado"
	...
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova231.png" alt="prova 231" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.9: Ejemplo sentencia condicional if</figcaption></figure></div>
...
=== "Resultado"
	...
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova232.png" alt="prova 232" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.10: Ejemplo sentencia condicional if-else</figcaption></figure></div>
...
=== "Ejemplo if-else if-else"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova233.png" alt="prova 233" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.11: Ejemplo sentencia condicional if-else-if-else</figcaption></figure></div>
...
=== "Ejemplo switch"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova234.png" alt="prova 234" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.12: Ejemplo sentencia condicional switch</figcaption></figure></div>
...
=== "Ejemplo while"
	...
	```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova237.png" alt="prova 237" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.13: Ejemplo sentencia repetitiva while </figcaption></figure></div>
...
=== "Ejemplo do-while"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova238.png" alt="prova 238" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.14: Ejemplo sentencia repetitiva do-while</figcaption></figure></div>
...
=== "Ejemplo for"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova239.png" alt="prova 239" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.15: Ejemplo sentencia repetitiva for</figcaption></figure></div>
...
=== "Ejemplo foreach"
    ...
    ```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova240.png" alt="prova 240" style="zoom:100%;border: 2px solid #83abd4;"" /><figcaption class="figure-caption-small">🖼️ Figura 2.16: Ejemplo sentencia repetitiva foreach</figcaption></figure></div>
...
>     ```
> === "Resultado"
>     <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova239b.png" alt="prova 239b" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.17: Ejemplo de uso de variable flag para substituir break o continue</figcaption></figure></div>
