...
---
# <img src="../../img/php_azul.svg" width="40"> 2.6. Funciones predefinidas
...
=== "Ejemplo cadenas"
	...
	```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova260.png" alt="prova260" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.38: Ejemplos de cadenas con o sin interpretar</figcaption></figure></div>
...
=== "Ejemplo caracteres"
    ...
    ```
=== "Resultado"
    <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova261.png" alt="prova261" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.39: Ejemplo de acceso a posición en una cadena</figcaption></figure></div>
...
=== "Ejemplo formatos"
	...
	```
=== "Resultado"
	<div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova263.png" alt="prova263" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.40: Ejemplo de uso de cadenas formateadas mediante printf()</figcaption></figure></div>
...
=== "Ejemplos funciones cadena"
    ...
    ```
=== "Resultado"
    <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova264.png" alt="prova264" style="zoom:100%;border: 2px solid #83abd4; /><figcaption class="figure-caption-small">🖼️ Figura 2.41: Ejemplos de usos de funciones básicas sobre cadenas</figcaption></figure></div>
...
=== "Ejemplo *ord* y *chr*"
    ...
    ```
=== "Resultado"
    <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova265.png" alt="prova265" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.42: Ejemplo de usos de función ord() y chr()</figcaption></figure></div>
...
=== "Ejemplo funciones cadena"
    ...
    ```
=== "Resultado"
    <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova266.png" alt="prova266" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.43: Ejemplos de funciones de limpieza de cadenas</figcaption></figure></div>
...
=== "Ejemplo funciones comparadoras"
    ...
    ```
=== "Resultado"
    <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova267.png" alt="prova267" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.44: Ejemplos de uso de funciones para comparar cadenas</figcaption></figure></div>
...
=== "Ejemplo funciones buscadoras"
    ...
    ```
=== "Resultado"
    <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova268.png" alt="prova268" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.45: Ejemplo de uso de funciones buscadoras</figcaption></figure></div>
...
=== "Funciones averiguar tipos"
    ...
    ```
=== "Resultado"
    <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova269.png" alt="prova269" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.46: Funciones (booleanas) para comprobar tipos de las cadenas</figcaption></figure></div>
...
=== "Ejemplo dividir cadenas"
    ...
    ```
=== "Resultado"
    <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova269b.png" alt="prova269b" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.47: Ejemplo uso de funciones para obtener subcadenas</figcaption></figure></div>
...
=== "Ejemplo subcadenas"
    ...
    ```
=== "Resultado"
    <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova269c.png" alt="prova269c" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.48: Ejemplo uso de funciones para obtener subcadenas</figcaption></figure></div>
...
=== "Ejemplo *number_format(args)*"
    ...
    ```
=== "Resultado"
    <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova269d.png" alt="prova269d" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.49: Ejemplo uso de funciones matemáticas en php</figcaption></figure></div>
...
=== "Ejemplo funciones redondeo"
    ...
    ```
=== "Resultado"
    <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova269e.png" alt="prova269e" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.50: Ejemplos usos de decimales</figcaption></figure></div>
...
=== "Ejemplo funciones check tipos"
    ...
    ```
=== "Resultado"
    <div style="text-align: center;"><figure><img src="../../img/ut02/ut02_prova269f.png" alt="prova269f" style="zoom:100%;border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 2.51: Ejemplo obtención tipo de datos y conversiones</figcaption></figure></div>
