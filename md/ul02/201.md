---
title: 7.1. Viaje de una petición
---
# <img src="../../img/laravel_azul.svg" width="40"> 7.1. Viaje de una petición
...
## 1. El flujo de una petición HTTP
...
!!!tenencuenta "index.php accesible"
...
```
<div style="text-align: center;"><figure><figcaption class="figure-caption-small">🖼️ Figura 7.1: Funcionamiento de Service Container</figcaption></figure></div>
...
### 3.1. El ciclo completo de una petición
...
flowchart TD
   ...
   B --> A
```
<div style="text-align: center;"><figure><figcaption class="figure-caption-small">🖼️ Figura 7.2: Diagrama del Flujo Completo de una petición en Laravel</figcaption></figure></div>
