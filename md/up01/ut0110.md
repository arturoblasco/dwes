...
# <img src="../../img/php_azul.svg" width="40"> 1.10. Puesta en marcha
...
!!!inst "Instalación"
    ...
    === "<div style="text-align:center;"><img src="../../img/windows.png" alt="windows" width=40 height=40 " /></div>"
        ...
        <div style="text-align: center;"><figure><img src="../../img/ut01/docker_desktop_wsl2.png" alt="Check para activación de WSL" style="zoom:70%; border: 2px solid #fff2c9;"/><figcaption class="figure-caption-small">🖼️ Figura 1.28: Check para activación de WSL --</figure></div>

        Cuando termine la instalación, reinicia tu máquina.
        
        <div style="text-align: center;"><figure><img src="../../img/ut01/dockerdesktop.png" alt="dockerdesktop" style="zoom:80%;" /><figcaption class="figure-caption-small">🖼️ Figura 1.29: Interfaz programa Docker Desktop -- </figcaption></figure></div>
...
???note "Portainer: docker de gestión de dockers"
    ...
    === "<div style="text-align:center;"><img src="../../img/linux.png" alt="linux" width=40 height=40 /></div>"
        ...
        <div style="text-align: center;"><figure><img src="../../img/ut01/docker_portainer1.png" alt="docker_portainer1" style="zoom:100%;" /><figcaption class="figure-caption-small">🖼️ Figura 1.30: Instalación del contenedor Portainer desde terminal</figcaption></figure></div>
    ...
    <div style="text-align: center;"><figure><img src="../../img/ut01/docker_portainer2.png" alt="docker_portainer2" style="zoom:80%; border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 1.31: Acceso a docker Portainer desde el puerto 9000</figcaption></figure></div>
    ...
    <div style="text-align: center;"><figure>``<img src="../../img/ut01/docker_portainer3.png" alt="docker_portainer3" style="zoom:80%; border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 1.32: Pestaña indicando reiniciar el docker Portainer</figcaption></figure></div>
    
    Volvemos a acceder vía **`https://localhost:9443`**:
    
    <div style="text-align: center;"><figure><img src="../../img/ut01/docker_portainer4.png" alt="docker_portainer4" style="zoom:80%; border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 1.33: Pestaña de inicio de docker Portainer -- </figcaption></figure></div>
...
???hint "Extra: órdenes en Docker"
    ...
    <div style="text-align:center;"><img src="../../img/ut01/docker-compose-up-d.png" alt="holamundo" style="zoom:80%; border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 1.34: Descarga e instalación de imágenes de docker-compose.yml</figcaption></figure></div>
...
- **PHP Sniffer**: asegura que el código PHP cumpla con los estándares de codificación establecidos. Puedes personalizar las reglas según las necesidades de tu proyecto.
- **Laravel Intelephense** (mamadou-diallo) - extiende Inetelephense con helpers de Laravel.
- **Laravel Extra Intelephense** (amiralizadeh9480) - sugiere rutas, vistas, config, modelos.
- **Laravel Artisan** (ryannaddy) - ejecuta comandos artisan desde la paleta.
- **Prettier** (shufo.vscode-blade-formatter) - formatea ficheros .blade.
- **Database Client** (cweijan.vscode-database-client) o **MySQL** - para base de datos.
- **GitHub Pull Requests and Issues** (github.vscode-pull-request-github).
- **GitLens** (eamodio.gitlens) - historial, blame, diffs.
...
<div style="text-align: center;"><figure><img src="../../img/ut01/vscodedocker.png" alt="vscodedocker" style="zoom:65%;" /><figcaption class="figure-caption-small">🖼️ Figura 1.35: Extensión Docker en Visual Studio Code</figcaption></figure></div>

### 3.1. Configurar llaves PHP en VS Code

Ir a **Archivo** → **Preferencias** → **Configurar fragmentos de código** (*File → Preferences → User Snippets*) seleccionar la opción **html** y agregar el *snippet* en el fichero **`html.json`**:
...
=== "Php"
    ...
    ```
=== "Resultado"
    <div style="text-align: center;"><figure><img src="../../img/ut01/holamundo.png" alt="holamundo" style="zoom:70%; border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 1.36: Página en php: Hola Mundo</figcaption></figure></div>
