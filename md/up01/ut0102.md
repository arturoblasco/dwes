...
# <img src="../../img/php_azul.svg" width="40"> 1.2. Arquitecturas web
...
<div style="text-align: center;"><img src="../../img/ut01/cli_serv.png" alt="cliente servidor" style="zoom:80%;" /><figcaption class="figure-caption-small">🖼️ Figura 1.1: Funcionamiento básico cliente-servidor</figcaption></div>
...
???example "Ejemplo con DevTools"
    **Peticiones desde el navegador**
    ...
    === "Paso 1"
        ...
        <div style="text-align: center;"><img src="../../img/ut01/ejemplo01.png" alt="ejemplo" style="zoom:50%; border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 1.2: Personaliza > Más herramientas > **Herramientas para desarroladores**</figcaption></div>
    
        Pestaña **Network** antes de refrescar:
        
        <div style="text-align: center;"><img src="../../img/ut01/ejemplo02.png" alt="ejemplo" style="zoom:50%; border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 1.3: Pestaña **Network** (antes de refrescar)</figcaption></div>
    ...
    === "Paso 3"
        ...
        <div style="text-align: center;"><img src="../../img/ut01/ejemplo03.png" alt="ejemplo" style="zoom:50%; border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 1.4: Detalles de la web en pestaña **Headers**</figcaption></div>
        ...
        <div style="text-align: center;"><img src="../../img/ut01/ejemplo05.png" alt="ejemplo" style="zoom:50%; border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 1.5: Detalles de la web en pestaña **Headers**</figcaption></div>
        ...
        <div style="text-align: center;"><img src="../../img/ut01/ejemplo06.png" alt="ejemplo" style="zoom:50%; border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 1.6: Algunas de las métricas que se observan</figcaption></div>
        ...
        <div style="text-align: center;"><img src="../../img/ut01/ejemplo07.png" alt="ejemplo" style="zoom:50%; border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 1.7: Fichero **.js** con su código desde **Preview**</figcaption></div>
        
        Si pinchamos en `logo-upv.svg` podremos ver que es el logo del ayuntamiento, transferido desde el servidor:
        
        <div style="text-align: center;"><img src="../../img/ut01/ejemplo08.png" alt="ejemplo" style="zoom:50%; border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 1.8: Fichero media **.svg**</figcaption></div>
        
        Todos estos ficheros tardan un tiempo en transferirse, lo que se representa en forma de *waterfall* (cascada):
        
        <div style="text-align: center;"><img src="../../img/ut01/ejemplo09.png" alt="ejemplo" style="zoom:50%; border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 1.9: Tiempos de transferencia en cascada</figcaption></div>
    ...
    === "Paso 4"
        ...
        <div style="text-align: center;"><img src="../../img/ut01/ejemplo10.png" alt="ejemplo" style="zoom:60%; border: 2px solid #83abd4;" /><figcaption class="figure-caption-small">🖼️ Figura 1.10: Interpretación en el **front‑end** (página renderizada por el navegador)</figcaption></div>
